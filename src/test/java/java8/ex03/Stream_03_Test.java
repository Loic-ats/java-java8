...
public class Stream_03_Test {
    ...
    public void test_joining() throws Exception {
        ...
        String result = customers.stream().sorted((c1, c2) -> c1.getFirstname().compareTo (c2.getFirstname())).map(p -> p.getFirstname()).collect(Collectors.joining("|"));
    ...
    public void test_mapping() throws Exception {
        ...
        Map<Gender, String> result = customers.stream().sorted((c1, c2) -> c1.getFirstname().compareTo (c2.getFirstname())).collect(Collectors.toMap (c-> c.getGender(), c -> c.getFirstname(),(f1,f2) -> f1 + "|" + f2));
